"""
SCRIPT 2 — Quadro de Horario das linhas novas
...
Uso:
    cd matrix
    python automation_novas_horario.py
"""
...
LOG_FILE   = Path(__file__).parent / "log_novas_horario.txt"
PROG_FILE  = Path(__file__).parent / "progress_novas_horario.json"
...
def main():
    print("=" * 60)
    print("QUADRO DE HORARIO — LINHAS NOVAS")
    print("=" * 60)
